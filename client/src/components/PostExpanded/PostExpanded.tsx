...
const PostExpanded: React.FC<PostExpandedProps> = ({
  ...
  const AudioAndPartOfSpeech: React.FC<AudioAndPartOfSpeechProps> = ({
    isLargeDevice,
  }) => {
    return (
    ...
    <section className="postExpandedContainer">
      ...
      <div className="largeDevicesContainer">
        <div className="largeDevicesInnerContainer">
          ...
          <img
            className="largeDevicesImage"
            src={isLoading ? placeholderImage : post.selectedFile}
            alt=""
          />
        </div>
      </div>
      ...
      <div className="smallDevicesContainer">
        {todaysDate && (
          <h2 className="smallDevicesHeading">
            WORD OF THE DAY
            <br />
